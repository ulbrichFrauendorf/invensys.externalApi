      ...
      IPaySpaceEmployeeApi
{
    ...
    /// <inheritdoc/>
    public async Task<List<Employee>> EmployeeListAsync(JwtAccessTokenRequest accessTokenRequest,
                                                        long companyId,
    ...
    /// <inheritdoc/>
    public async Task<List<EmploymentStatus>> EmployeeEmploymentStatusAllAsync(JwtAccessTokenRequest accessTokenRequest, long companyId)
    {
        return await _payspaceApiClient.GetListAsync<EmploymentStatus>(accessTokenRequest, $"{companyId}/EmployeeEmploymentStatus/all");
    }
    ...
    /// <inheritdoc/>
    public async Task<List<EmployeeBankDetail>> EmployeeBankDetailAsync(JwtAccessTokenRequest accessTokenRequest, long companyId)
    {
        return await _payspaceApiClient.GetListAsync<EmployeeBankDetail>(accessTokenRequest, $"{companyId}/EmployeeBankDetail");
    }

    /// <inheritdoc/>
    public async Task<List<Address>> EmployeeAddressAsync(JwtAccessTokenRequest accessTokenRequest, long companyId, string employeeNumber)
    {
        return await _payspaceApiClient.GetListAsync<Address>(accessTokenRequest, $"{companyId}/EmployeeAddress/{employeeNumber}");
    }
}
