...
namespace Invensys.ExternalApi.UnitTests.PaySpace
{
   ...
   public class PayspaceEmployeeApiTests
   {
      ...
      public async Task EmployeeListAsync_WithEffectiveDateAndEmployeeNumbers_ShouldReturnEmployees()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsyncWithListFilter<Employee>(
                  _accessTokenRequest,
                  $"{companyId}/Employee/effective/{effectiveDate:yyyy-MM-dd}",
                  "EmployeeNumber",
                  employeeNumbers
         ...
         var result = await _paySpaceEmployeeApi.EmployeeListAsync(
            _accessTokenRequest,
            companyId,
            effectiveDate,
            employeeNumbers
      ...
      public async Task EmployeePositionsAsync_ShouldReturnEmployeePositions()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<EmployeePosition>(
                  _accessTokenRequest,
      ...
      public async Task EmployeeEmploymentStatusAsync_ShouldReturnEmploymentStatuses()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<EmploymentStatus>(
                  _accessTokenRequest,
      ...
      public async Task EmployeeBankDetailAsync_ShouldReturnEmployeeBankDetails()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<EmployeeBankDetail>(_accessTokenRequest, $"{companyId}/EmployeeBankDetail")
            )
      ...
      public async Task EmployeeAddressAsync_ShouldReturnEmployeeAddresses()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<Address>(_accessTokenRequest, $"{companyId}/EmployeeAddress/{employeeNumber}")
            )
