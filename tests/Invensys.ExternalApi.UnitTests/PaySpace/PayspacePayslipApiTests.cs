   ...
   public class PayspacePayslipApiTests
   {
      ...
      public async Task GetConsolidatedEmployeePayslipsAsync_ShouldReturnConsolidatedPayslips()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<EmployeePayslip>(
                  _accessTokenRequest,
         ...
         var result = await _paySpacePayslipApi.GetConsolidatedEmployeePayslipsAsync(
            _accessTokenRequest,
            companyId,
            year,
            month
      ...
      public async Task GetEmployeePayslipLinesAsync_ShouldReturnPayslipLines()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<EmployeePayslipLine>(
                  _accessTokenRequest,
         ...
         var result = await _paySpacePayslipApi.GetEmployeePayslipLinesAsync(
            _accessTokenRequest,
            companyId,
            year,
            month
      ...
      public async Task GetEmployeePayslipsAsync_ShouldReturnPayslips()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<EmployeePayslip>(_accessTokenRequest, $"{companyId}/EmployeePayslip/{year}/{month}")
            )
            .ReturnsAsync(expectedPayslips);
      ...
      public async Task GetEmployeePayslipsAsync_WithComponentCodes_ShouldReturnPayslips()
      {
         ...
         var result = await _paySpacePayslipApi.GetEmployeePayslipsAsync(
            _accessTokenRequest,
            companyId,
            year,
            month,
