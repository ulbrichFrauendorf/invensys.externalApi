   ...
   public class PayspaceLookupApiTests
   {
      ...
      public async Task GetCompanyPensionFundAsync_ShouldReturnCompanyPensionFunds()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<GenLookupValue>(_accessTokenRequest, $"{companyId}/Lookup/CompanyPensionFund")
            )
      ...
      public async Task GetNatureOfPersonAsync_ShouldReturnNatureOfPersons()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<GenLookupValue>(_accessTokenRequest, $"{companyId}/Lookup/NatureOfPerson")
            )
      ...
      public async Task GetOrganizationLevelsAsync_ShouldReturnOrganizationLevels()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<GenLookupValue>(_accessTokenRequest, $"{companyId}/Lookup/OrganizationLevel")
            )
      ...
      public async Task GetOrganizationGroupsAsync_ShouldReturnOrganizationGroups()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<GenLookupValue>(_accessTokenRequest, $"{companyId}/Lookup/OrganizationGroup")
            )
      ...
      public async Task GetOrganizationCategoriesAsync_ShouldReturnOrganizationCategories()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<GenLookupValue>(_accessTokenRequest, $"{companyId}/Lookup/OrganizationCategory")
            )
