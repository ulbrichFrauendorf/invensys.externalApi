   ...
   public class PaySpaceCompanyApiTests
   {
      ...
      public async Task GetCompanyFrequenciesAsync_ShouldReturnCompanyFrequencies()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<CompanyFrequency>(_accessTokenRequest, $"{companyId}/Lookup/CompanyFrequency")
            )
      ...
      public async Task GetCompanyFrequenciesAsync_ShouldThrowException_OnApiFailure()
      {
         ...
         await FluentActions
            .Invoking(() => _paySpaceCompanyApi.GetCompanyFrequenciesAsync(_accessTokenRequest, companyId))
            .Should()
      ...
      public async Task GetPensionFundComponentCompanyAsync_ShouldReturnData()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<PensionFundComponentCompany>(
                  _accessTokenRequest,
                  $"{companyId}/Lookup/PensionFundComponentCompany?frequency={frequency}&period={period}"
               )
            )
            .ReturnsAsync(expectedData);

         var result = await _paySpaceCompanyApi.GetPensionFundComponentCompanyAsync(
            _accessTokenRequest,
            companyId,
            frequency,
            period
      ...
      public async Task GetPensionFundComponentCompanyAsync_ShouldThrowException_OnApiFailure()
      {
         ...
         await FluentActions
            .Invoking(
               () =>
                  _paySpaceCompanyApi.GetPensionFundComponentCompanyAsync(
                     _accessTokenRequest,
                     companyId,
                     frequency,
                     period
      ...
      public async Task GetOrganizationUnitsAsync_ShouldReturnData()
      {
         ...
         _paySpaceApiClientMock
            .Setup(client =>
               client.GetListAsync<OrganizationUnit>(_accessTokenRequest, $"{companyId}/OrganizationUnit")
            )
      ...
      public async Task GetOrganizationUnitsAsync_ShouldThrowException_OnApiFailure()
      {
         ...
         await FluentActions
            .Invoking(() => _paySpaceCompanyApi.GetOrganizationUnitsAsync(_accessTokenRequest, companyId))
            .Should()
            .ThrowAsync<Exception>()
            .WithMessage("API Error");
      }
      ...
      public async Task CompanySettingsAsync_ShouldThrowException_OnApiFailure()
      {
         ...
         await FluentActions
            .Invoking(() => _paySpaceCompanyApi.CompanySettingsAsync(_accessTokenRequest, companyId))
            .Should()
            .ThrowAsync<Exception>()
            .WithMessage("API Error");
      }
